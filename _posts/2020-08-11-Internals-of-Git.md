...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/1.png" alt="Git DAG"><figcaption>A sample Directed Acyclic Graph. In Git, each node represents an <em>Object</em></figcaption></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/tree.png" alt="Tree pointing to blobs"><figcaption>A tree pointing to two blobs</figcaption></figure>

Or another way to view a tree: (the top level tree contains another tree, *foo*, and a blob, *baz.txt*)

<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/tree_vis.png" alt="Alternate tree"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/commit.png" alt="A commit"><figcaption>A commit</figcaption></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/hash.png" alt="Example Hashes"><figcaption>Example Hashes</figcaption></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/refs.png" alt="The refs folder"><figcaption>Git stores four types of refs</figcaption></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/commits_timeline.png" alt="Timeline of commits"><figcaption>Visualizing a Sample Commit History</figcaption></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a1.png" alt=".git"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a2.png" alt="HEAD contents"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a3.png" alt="master contents"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a4.png" alt="cat file type"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a5.png" alt="cat file print"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a6.png" alt="print tree"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a7.png" alt=".git"><figcaption>Revealing the contents of the blob with hash de1af..., which is of the file requirements.txt</figcaption></figure>

Finally, while inpecting the commit, we saw the it had another field called *parent*

<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a8.png" alt="parent in commit"></figure>
...
<figure class="image" style="text-align: center; color: gray;"><img src="/assets/img/Internals-of-Git/a9.png" alt="type of parent in commit"></figure>
